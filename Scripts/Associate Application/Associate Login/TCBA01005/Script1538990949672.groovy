...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Log In  5-15/input_txtPassword'), 'vyMhy6SxYBeQFo6WXSfM3HzeL6uKQedE')

WebUI.click(findTestObject('Object Repository/Page_Log In  5-15/button_Log in'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Log In  5-15/div_Invalid username or passwo'), 0)
