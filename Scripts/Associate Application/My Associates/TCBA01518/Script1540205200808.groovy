...
WebUI.verifyElementPresent(findTestObject('Object Repository/My Associates/Page_My Associates  5-15/input_txtBirthStateCode'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/My Associates/Page_My Associates  5-15/input_txtBirthCity'), 
    0)
