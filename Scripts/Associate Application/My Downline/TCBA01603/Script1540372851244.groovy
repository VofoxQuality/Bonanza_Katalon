...
WebUI.click(findTestObject('Object Repository/My Downline/Page_My Downline  5-15/span_List View'))
...
WebUI.verifyElementText(findTestObject('My Downline/Page_My Downline  5-15/h3_List view'), 'List View')

WebUI.verifyElementText(findTestObject('Object Repository/My Downline/Page_My Downline  5-15/button_FILTER'), 'FILTER')
